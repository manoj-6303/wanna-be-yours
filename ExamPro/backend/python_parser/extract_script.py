...
def process_pdf(job_id: str, file_path: str, output_file: str):
    try:
...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        print("Usage: python extract_script.py <pdf_path> <output_json_path>")
        sys.exit(1)
    process_pdf("job_area", sys.argv[1], sys.argv[2])
